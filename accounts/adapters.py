...
GROUP_ADMIN = "bestellingenNoord-admin"
GROUP_TEACHER = "bestellingenNoord-teacher"
GROUP_STUDENT = "bestellingenNoord-student"
...
class AuthentikSocialAccountAdapter(DefaultSocialAccountAdapter):
    ...
    def _sync_user_fields(self, user, data):
        ...
        if GROUP_ADMIN in groups:
            ...
            user.is_staff = True
        elif GROUP_TEACHER in groups:
            user.role = User.ROLE_TEACHER
            user.is_staff = False
        elif GROUP_STUDENT in groups:
